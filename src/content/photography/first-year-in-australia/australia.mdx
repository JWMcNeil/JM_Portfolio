...
import Melbourne from './Melbourne-Skyline.jpg';
import Noosa from './Noosa1.jpg';
...
<Image src={Melbourne} alt="View of Melbourne skyline from St Kilda Pier" />
<Image src={Noosa} alt="A beach at Noosa" />
